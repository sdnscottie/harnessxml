...
- [`LICENSE-SPEC`](https://github.com/scottsoft/harnessxml/blob/main/LICENSE-SPEC) — CC BY 4.0 terms and scope
- [`LICENSE-CODE`](https://github.com/scottsoft/harnessxml/blob/main/LICENSE-CODE) — full Apache 2.0 text
